...
plus [contact info]({{ site.baseurl }}/contact/), and even a few [blog posts]({{ site.baseurl }}/posts/). This site also hosts some of my software, such as [kilobeat]({{ site.baseurl }}/kilobeat/), [Alternator]({{ site.baseurl }}/alternator/), and [ScoreCard]({{ site.baseurl }}/s).
